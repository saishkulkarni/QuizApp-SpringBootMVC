...
<body>
	...
	<form action="/trainer/question-add-mcq" method="post" id="mcq-question" class="question-form">
	...
	<form action="/trainer/question-add-truefalse" method="post"
		...
		<label for="truefalse-question-text">Write Question:</label> <input
			type="text" name="question" id="truefalse-question-text" required><br> <label
			for="truefalse-marks">Marks:</label> <input type="number"
			id="truefalse-marks" name="marks" required min="1" step="1"><br> <label
			for="truefalse-option-true">True:</label> <input type="radio"
			name="answer" value="true"> Correct Answer<br>

		<label for="truefalse-option-false">False:</label> <input type="radio"
			name="answer" value="false"> Correct Answer<br>
